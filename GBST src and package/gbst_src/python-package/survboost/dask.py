...
from .sklearn import SurvModel, SurvClassifierBase
...
class DaskScikitLearnBase(SurvModel):
...
class DaskSurvRegressor(DaskScikitLearnBase):
    # pylint: disable=missing-docstring
    __doc__ = ('Implementation of the scikit-learn API for SurvBoost ' +
               'regression. \n\n') + '\n'.join(
                   SurvModel.__doc__.split('\n')[2:])
...
class DaskSurvClassifier(DaskScikitLearnBase, SurvClassifierBase):
    # pylint: disable=missing-docstring
    _client = None
    __doc__ = ('Implementation of the scikit-learn API for SurvBoost ' +
               'classification.\n\n') + '\n'.join(
