...
import json
import numpy as np
from .core import Booster, DMatrix, SurvBoostError
...
from .compat import (SKLEARN_INSTALLED, SurvModelBase,
                     SurvClassifierBase, SurvLabelEncoder)
...
class SurvModel(SurvModelBase):
    ...
    def get_params(self, deep=False):
        """Get parameters."""
        params = super(SurvModel, self).get_params(deep=deep)
    ...
    def get_surv_params(self):
        """Get xgboost type parameters."""
        surv_params = self.get_params()
        return surv_params
    ...
    def fit(self, X, y, sample_weight=None, eval_set=None, eval_metric=None,
            early_stopping_rounds=None, verbose=True, surv_model=None,
        ...
        self._Booster = train(params, trainDmatrix,
                              ...
                              verbose_eval=verbose, surv_model=surv_model,
                              callbacks=callbacks)
    ...
    def evals_result(self):
        ...
        **evals_result** will contain the **eval_metrics** passed to the `fit` function.
        ...
        if self.evals_result_:
            ...
            raise SurvBoostError('No results.')
