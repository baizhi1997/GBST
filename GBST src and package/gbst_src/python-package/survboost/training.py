...
import warnings
import numpy as np
from .core import Booster, STRING_TYPES, SurvBoostError, CallbackEnv, EarlyStopException
from .compat import (SKLEARN_INSTALLED, SurvStratifiedKFold)
from . import rabit
...
def _train_internal(params, dtrain,
                    ...
                    feval=None,
                    surv_model=None, callbacks=None):
    ...
    if isinstance(params, dict) \
        ...
        params['objective'] = "multi:survtree"
        ...
        params.append(('objective', 'multi:survtree'))
    else:
        params['objective'] = "multi:survtree"
...
def train(params, dtrain, num_boost_round=10, evals=(), feval=None,
          maximize=False, early_stopping_rounds=None, evals_result=None,
          verbose_eval=True, surv_model=None, callbacks=None, learning_rates=None):
    ...
    learning_rates: list or function (deprecated - use callback API instead)
        ...
        learning rate decay)
    surv_model : file name of stored xgb model or 'Booster' instance
    ...
    return _train_internal(params, dtrain,
                           ...
                           evals=evals,
                           feval=feval,
                           surv_model=surv_model, callbacks=callbacks)
...
def mknfold(dall, nfold, param, seed, evals=(), fpreproc=None, stratified=False,
    ...
    if stratified is False and folds is None:
        ...
        sfk = SurvStratifiedKFold(n_splits=nfold, shuffle=True, random_state=seed)
...
def cv(params, dtrain, num_boost_round=10, nfold=3, stratified=False, folds=None,
    ...
    if stratified is True and not SKLEARN_INSTALLED:
        raise SurvBoostError('sklearn needs to be installed in order to use stratified cv')
