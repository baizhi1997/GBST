...
try:
    ...
    SurvModelBase = BaseEstimator
    SurvClassifierBase = ClassifierMixin

    SurvKFold = KFold
    SurvStratifiedKFold = StratifiedKFold
    SurvLabelEncoder = LabelEncoder
except ImportError:
    SKLEARN_INSTALLED = False

    # used for compatibility without sklearn
    SurvModelBase = object
    SurvClassifierBase = object
    SurvRegressorBase = object

    SurvKFold = None
    SurvStratifiedKFold = None
    SurvLabelEncoder = None
