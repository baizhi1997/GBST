...
import warnings
import numpy as np
from .core import Booster, STRING_TYPES, gbstError, CallbackEnv, EarlyStopException
from .compat import (SKLEARN_INSTALLED, gbstStratifiedKFold)
from . import rabit
...
def _train_internal(params, dtrain,
                    ...
                    feval=None,
                    gbst_model=None, callbacks=None):
    ...
    if gbst_model is not None:
        bst = Booster(params, [dtrain] + [d[0] for d in evals],
                      model_file=gbst_model)
...
def train(params, dtrain, num_boost_round=10, evals=(), feval=None,
          ...
          verbose_eval=True, gbst_model=None, callbacks=None, learning_rates=None):
    ...
    return _train_internal(params, dtrain,
                           ...
                           evals=evals,
                           feval=feval,
                           gbst_model=gbst_model, callbacks=callbacks)
...
def mknfold(dall, nfold, param, seed, evals=(), fpreproc=None, stratified=False,
    ...
    if stratified is False and folds is None:
        ...
        sfk = gbstStratifiedKFold(n_splits=nfold, shuffle=True, random_state=seed)
...
def cv(params, dtrain, num_boost_round=10, nfold=3, stratified=False, folds=None,
    ...
    if stratified is True and not SKLEARN_INSTALLED:
        raise gbstError('sklearn needs to be installed in order to use stratified cv')
